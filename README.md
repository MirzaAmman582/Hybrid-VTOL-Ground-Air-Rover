...
* **Power Management:** Designed a redundant power system utilizing 3S LiPo batteries for flight and dedicated Li-ion packs for ground operation to maximize mission endurance.
...
* `/Docs`: `Postgrad_Dissertation_Hybrid_Rover.pdf` - The complete 60+ page technical report.
* `/Firmware`: Custom Arduino ground control scripts and Pixhawk configuration logs.
* `README.md`: Executive summary and technical specifications.
